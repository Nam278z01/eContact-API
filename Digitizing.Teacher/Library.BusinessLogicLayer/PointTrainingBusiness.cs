...
{
    public partial class PointTrainingBusiness : IPointTrainingBusiness
    {
        private IPointTrainingRepository _res;
        public PointTrainingBusiness(IPointTrainingRepository res)
        {
            _res = res;
        }
